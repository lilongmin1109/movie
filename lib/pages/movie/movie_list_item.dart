...
import 'package:movie_app/widget/movie_cover_image.dart';
...
class MovieListItem extends StatelessWidget {
  ...
  Widget _getActionWidget(BuildContext context) {
    ...
    String pubdate = movie.mainland_pubdate;
    if (pubdate != '') {
      pubdate = movie.mainland_pubdate.split('-')[1] +
          '月\n' +
          movie.mainland_pubdate.split('-')[2] +
          '日';
    } else {
      pubdate = '待定';
    }
...
//        );
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    '${movie.year} /${genres2String(movie.genres)}/${director2String(movie.directors)}/${actor2String(movie.casts)}',
  ...
  String director2String(List<Director> actors) {
  ...
  String actor2String(List<Cast> actors) {
    StringBuffer sb = new StringBuffer();
    actors.forEach((actor) {
      sb.write(' ${actor.name} ');
    });
