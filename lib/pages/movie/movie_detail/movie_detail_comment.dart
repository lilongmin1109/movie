...
class MovieDetailComment extends StatelessWidget {
  ...
  final List<PopularCommentsListBean> comments;

  const MovieDetailComment({Key key, this.comments}) : super(key: key);
...
class CommentItemView extends StatelessWidget {
  ...
  final PopularCommentsListBean comment;
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 10,),
                      Text(comment.createdAt.split(' ')[0], style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppColor.lightGrey),),
                    ],
                  ),
                ],
              ),
