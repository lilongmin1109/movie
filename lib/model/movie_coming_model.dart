class MovieComingModel {
  int count;
  int start;
  List<ComingSubject> subjects;
  String title;
  int total;

  MovieComingModel(
      {this.count, this.start, this.subjects, this.title, this.total});

  factory MovieComingModel.fromJson(Map<String, dynamic> json) {
    return MovieComingModel(
      count: json['count'],
      start: json['start'],
      subjects: json['subjects'] != null
          ? (json['subjects'] as List).map((i) => ComingSubject.fromJson(i)).toList()
          : null,
      title: json['title'],
      total: json['total'],
    );
...
class ComingSubject {
  ...
  factory ComingSubject.fromJson(Map<String, dynamic> json) {
    return ComingSubject(
      alt: json['alt'],
      casts: json['casts'] != null
          ? (json['casts'] as List).map((i) => Cast.fromJson(i)).toList()
          : null,
      ...
      durations: json['durations'] != null
          ? new List<String>.from(json['durations'])
          : null,
      genres:
      ...
      pubdates: json['pubdates'] != null
          ? new List<String>.from(json['pubdates'])
          : null,
...
class Director {
  ...
  factory Director.fromJson(Map<String, dynamic> json) {
    return Director(
      alt: json['alt'],
      avatars:
          json['avatars'] != null ? AvatarsX.fromJson(json['avatars']) : null,
      id: json['id'],
      name: json['name'],
      name_en: json['name_en'],
    );
