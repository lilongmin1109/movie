...
class MovieItem {
  ...
  MovieItem({this.alt, this.casts, this.collect_count, this.directors, this.durations, this.genres, this.has_video, this.id, this.images, this.mainland_pubdate, this.original_title, this.pubdates, this.rating, this.subtype, this.title, this.year});
